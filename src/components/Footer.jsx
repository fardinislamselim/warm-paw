...
const Footer = () => {
  return (
    <footer className="bg-base-100 text-gray-600 mt-4 border-base-300">
      ...
      <div className="border-t border-base-300 text-center py-4 text-sm text-gray-600 font-body bg-base-200">
